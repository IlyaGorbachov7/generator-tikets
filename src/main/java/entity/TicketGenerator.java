...
import threads.ContentExtractThread;
import threads.OutputContentFormationThread;
...
public class TicketGenerator implements Callable<Map<String, List<Question>>> {
     ...
     * <p>
     * 23.04.2022
     * I had to think carefully about the question: If a thread is interrupted, are all resources and threads closed correctly?
