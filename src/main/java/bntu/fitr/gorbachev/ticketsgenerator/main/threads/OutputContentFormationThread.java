...
import bntu.fitr.gorbachev.ticketsgenerator.main.entity.WrapXml;
        ...
        for (var ticket : listTickets) {
            ...
            for (var question : ticket.getQuestions()) {
                ...
                for (var resP : question.getListParagraphs()) {
                    ...
                    OutputContentFormationThread.setParagraphProperties(desP);
                    ...
                    while (xmlcursor.hasNextToken()) { // moving along the paragraph
                        ...
                        if (xmlcursor.isStart()) {// if position token located in start any tag
                            ...
                            if (xmlcursor.getName().getPrefix().equalsIgnoreCase("w") &&
                                ...
                                OutputContentFormationThread.cloneRunProperties(resR, desR);
                                // however, setting properties run according standard requirement
                                desR.setFontFamily("Times New Roman");
                                desR.setFontSize(14);

                                OutputContentFormationThread.clonePictureRun(resR, desR);
                            }
...
//            ctTblWidth.setW((16 * 0.4) * 1_440);// ширина таблицы
     ...
     * @throws Exception in case general troubles
     */
    private static void clonePictureRun(XWPFRun resR, XWPFRun desR)
            throws Exception {
     ...
     */
    private static void setRunProperties(XWPFRun run)
            throws XmlException {
     ...
     */
    private static void cloneParagraphProperties(XWPFParagraph source,
                                                 XWPFParagraph dest) {
     ...
     * @throws XmlException in case no correct format
     */
    private static void setParagraphProperties(XWPFParagraph p)
            throws XmlException {
     ...
     */
    private static void setConfig(XWPFParagraph p, ParagraphAlignment align,
     ...
     */
    private static BigInteger getNewDecimalNumberingId(XWPFDocument document,
     ...
     * @throws Exception in case general troubles
     */
    private static CTAnchor getAnchorWithGraphicByTemplate(CTGraphicalObject graphicRsc,
     ...
     * @throws Exception in case general troubles
     */
    private static CTAnchor getAnchorWithGraphicByWrapType(WrapXml wrapXml,
