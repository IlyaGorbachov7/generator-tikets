...
import bntu.fitr.gorbachev.ticketsgenerator.main.views.gui.panels.impl.*;

import java.awt.*;

/**
 * This class is a factory for creating bntu.fitr.gorbachev.ticketsgenerator.main.views.gui.panels
 *
 * @author Gorvachev I. D.
 * @version 15.10.2022
 * @apiNote Some factory methods throw exception {@link IllegalArgumentException}
 * @see bntu.fitr.gorbachev.ticketsgenerator.main.views.gui.frames.FrameDialogFactory
 * @see PanelType
 */
